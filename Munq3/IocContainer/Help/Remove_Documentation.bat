...
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale en-us /uninstall /silent /vendor "Vendor Name" /mediaBookList "Munq IOC Container Class Library Help File" /productName "Munq IOC Container Class Library Help File"
