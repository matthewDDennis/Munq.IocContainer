...
namespace Munq
{
    public class Container : IIocContainer
    {
        ...
        public IRegistration Register<TType>(Func<IIocContainer, TType> func) 
            where TType : class
        {
            if (func == null)
        ...
        public IRegistration Register<TType>(string name, Func<IIocContainer, TType> func) 
            where TType : class
        {
            if (func == null)
                throw new ArgumentNullException("func", "func is null.");
        ...
        {
            return Register<TType>(GetFactoryMethod<TType, TImpl>());
        }
